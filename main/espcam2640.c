...
/* esp32-cam camera application. sensor = ov7670--no ov2640
...
static camera_config_t camera_config =
{
    ...
    .frame_size = FRAMESIZE_UXGA,// biggest size for ov2640 fro fb init. if uxga, only one framebuffer and slow streaming!!! but big picture

    .jpeg_quality = 10, //not used
    .fb_count = 1 //number of framebuffers to use for capturing, if > 1, i2s runs in continuous mode.set automaticly!!
};
